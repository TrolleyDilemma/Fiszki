...
/**
 * ActionListener for Unknown List MenuItem. It loads List Panel to main window and initialize it with unknown vocabulary.
 * @author Michal Glogowski
 */
public class UnknownListActionListener implements ActionListener {
    @Override
    public void actionPerformed(ActionEvent e) {
        ...
        App.getExecutorService().execute(() -> {
            ...
            List<Word> words = App.getVocabulary().get(VocabularyType.UNKNOWN);
            words.forEach(word -> {
